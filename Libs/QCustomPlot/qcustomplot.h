/**
 * \file qcustomplot.h
 * \brief Внешняя библиотека QCustomPlot (виджет графиков для Qt).
 * \details Третьесторонний код. См. лицензию и документацию в исходниках QCustomPlot. Правки логики не вносить.
 */
